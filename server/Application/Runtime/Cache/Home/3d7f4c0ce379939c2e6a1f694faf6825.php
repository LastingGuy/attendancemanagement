...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li class="active"><a href="../Attendance/index"><span class="glyphicon glyphicon-th"></span> 考勤管理</a></li>
        ...
        <li><a href="../Upload/index"><span class="glyphicon glyphicon-pencil"></span> 文件上传</a></li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="../../Background/Upload/upload" enctype="multipart/form-data" method="post" >
