...
<title>Wopop</title>
<link href="<?php echo ($res_path); ?>/Wopop_files/style_log.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="<?php echo ($res_path); ?>/Wopop_files/style.css">
<link rel="stylesheet" type="text/css" href="<?php echo ($res_path); ?>/Wopop_files/userpanel.css">
<link rel="stylesheet" type="text/css" href="<?php echo ($res_path); ?>/Wopop_files/jquery.ui.all.css">
...
<form method="post" action="../Index/vertify" enctype="multipart/form-data">
  <h2>USERNAME</h2>
  <label>
