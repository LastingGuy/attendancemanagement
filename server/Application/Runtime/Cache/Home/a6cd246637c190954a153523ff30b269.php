...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="../Major/index"><span class="glyphicon glyphicon-list-alt"></span> 专业管理</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">专 业 情 况</div>
                <div class="panel-body">
                    ...
                    <table id="table" data-toggle="table" data-url=""  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                        ...
                        <tr>
                            ...
                            <th data-field="id" data-sortable="true">专业号</th>
                            <th data-field="name">专业名</th>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td></td>
                                <td><?php echo ($vo["zcy_mno"]); ?></td>
                                <td><?php echo ($vo["zcy_mname"]); ?></td>
                                <td><button class="btn btn-primary btn-xs" data-toggle="modal"
                                            data-target="#changeModal" onclick="edit_before(<?php echo ($vo["zcy_mno"]); ?>);">编 辑</button></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post"  enctype="multipart/form-data">
                    <div class="form-group">
                        <div id="check1">
                            <label  class="col-lg-2 col-lg-offset-1 control-label">专业号</label>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="请输入专业号"  id="id" name="id">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div id="check2">
                            <label  class="col-lg-2 col-lg-offset-1 control-label">专业名</label>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="请输入专业名"  id="name" name="name">
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <form class="form-horizontal" method="post"  enctype="multipart/form-data">
                    <div class="form-group">
                        <div>
                            <label  class="col-lg-2 col-lg-offset-1 control-label">专业号</label>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="请输入专业号"  id="eid" name="eid">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div>
                            <label  class="col-lg-2 col-lg-offset-1 control-label">专业名</label>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="请输入专业名"  id="ename" name="ename">
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    function edit_before(tid){
        $.get("../Major/editBefore",{
            "id":tid
        },function(data,status){
            $("#eid").val(data[0]['zcy_mno']);
            $("#ename").val(data[0]['zcy_mname']);
